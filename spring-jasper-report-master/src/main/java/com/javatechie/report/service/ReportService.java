...
public class ReportService {
    ...
    public String exportReport(String reportFormat) throws FileNotFoundException, JRException {
        String path = "C:\\Users\\Admin\\Desktop\\Report";
        ...
        parameters.put("createdBy", "Tarun Kumar Chinta");
        ...
        if (reportFormat.equalsIgnoreCase("pdf")) {
            ...
            JasperExportManager.exportReportToPdfFile(jasperPrint, path + "\\employees.csv");
        }
